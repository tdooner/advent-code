...
17/answer: 17/process.rb
	...
	echo "part 1:" > $@
	ruby 17/process.rb pgflpeqp >>$@
	MODE=longest ruby 17/process.rb kglvqrro | grep -E '^492$$'
	MODE=longest ruby 17/process.rb ulqzkmiv | grep -E '^830$$'
	echo "part 2:" >> $@
	MODE=longest ruby 17/process.rb pgflpeqp >>$@
